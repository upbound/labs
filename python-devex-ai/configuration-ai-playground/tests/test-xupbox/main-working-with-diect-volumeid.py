...
ebsvolume=v1beta1ebsvolume.EBSVolume(
    ...
    metadata=metav1.ObjectMeta(
        annotations={
            "crossplane.io/composition-resource-name": "ebsvolume"
        },
        labels={
...
ebssnapshot=v1beta1ebssnapshot.EBSSnapshot(
    ...
    metadata=metav1.ObjectMeta(
        annotations={
            "crossplane.io/composition-resource-name": "ebssnapshot"
        },
        labels={
...
ebsrootsnapshot=v1beta1ebssnapshot.EBSSnapshot(
    ...
    metadata=metav1.ObjectMeta(
        annotations={
            "crossplane.io/composition-resource-name": "ebsrootsnapshot"
        },
        name="huggingface-deep-learning-neuron-markus-schweig",
        labels={
...
observed_instance = deepcopy(instance)
observed_instance.status = v1beta1instance.Status(
...
test = compositiontest.CompositionTest(
    ...
    spec = compositiontest.Spec(
        ...
        observedResources=[observed_instance.model_dump(exclude_unset=True)],
        timeoutSeconds=120,
        validate=False,
    )
)
