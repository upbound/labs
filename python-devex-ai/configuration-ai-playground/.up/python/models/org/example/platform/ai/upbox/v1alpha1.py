...
#   filename:  workdir/ai_platform_example_org_v1alpha1_upbox.yaml
...
class FieldModel(BaseModel):
    ...
    items: List[Upbox]
    """
    List of upboxes. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
